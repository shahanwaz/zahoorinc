    ...
    <footer className="bg-emerald-900 text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-emerald-300/80 text-sm leading-relaxed max-w-sm mb-6">
              Connecting the global Shia Muslim community through spiritual tools, community services, 
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: "Ejara Services", path: "EjaraServices" },
                { label: "Istikhara", path: "Istikhara" },
                { label: "Find Maulana", path: "FindMaulana" },
              ].map((link) => (
                <li key={link.label}>
                  <button
                    onClick={() => base44.auth.redirectToLogin()}
                    className="text-emerald-300/80 hover:text-white text-sm transition-colors hover:translate-x-1 inline-block"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: "Help & Report", path: "HelpAndReportContent" },
                { label: "Donate & Support", path: "DonationSupport" },
              ].map((link) => (
                <li key={link.label}>
                  <button
                    onClick={() => base44.auth.redirectToLogin()}
        ...
        <div className="border-t border-emerald-700/50 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-emerald-400/70 text-sm text-center md:text-left">
            © {new Date().getFullYear()} Zahoor. All rights reserved. Built with ❤️ for the Ummah.
          </p>
