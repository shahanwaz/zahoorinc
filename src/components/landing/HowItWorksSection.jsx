...
const steps = [
  ...
  { step: "02", icon: "🎭", title: "Select Your Role", desc: "Choose your role — General User, Maulana, Zakir, Zakera, or Tutor — to get a personalized experience." },
    ...
    <section id="how-it-works" ref={ref} className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="works-pat" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-emerald-100 text-emerald-700 text-sm font-semibold tracking-wide uppercase mb-4">
            Getting Started
          </span>
                ...
                >
                  ...
                  <div className={`flex-1 ${isEven ? "md:text-right md:pr-16" : "md:pl-16"}`}>
                    <div className={`inline-block mb-3`}>
                      <span className="text-5xl font-black text-emerald-100 leading-none">{step.step}</span>
                    </div>
