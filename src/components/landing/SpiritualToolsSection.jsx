...
const tools = [
  ...
  { icon: "📖", title: "Duas & Ziyarat", desc: "Hundreds of authentic Duas and Ziyarat in Arabic with transliteration and translation.", gradient: "from-amber-500 to-amber-700" },
...
export default function SpiritualToolsSection() {
  ...
  return (
    <section id="spiritual" ref={ref} className="py-24 relative overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900">
        ...
        <svg className="w-full h-full opacity-[0.07]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="spirit-pat" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
              ...
              <path d="M60 10 L60 110 M10 60 L110 60" stroke="white" strokeWidth="0.3"/>
            </pattern>
          </defs>
      ...
      {/* Floating Particles */}
      {[
        { x: 5, y: 20, delay: 0, size: "8px" },
        { x: 90, y: 15, delay: 1, size: "12px" },
        { x: 15, y: 70, delay: 0.5, size: "6px" },
        { x: 85, y: 65, delay: 1.5, size: "10px" },
        { x: 50, y: 90, delay: 0.8, size: "8px" },
        { x: 30, y: 10, delay: 1.2, size: "5px" },
        { x: 70, y: 85, delay: 0.3, size: "7px" },
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm text-emerald-200 text-sm font-semibold tracking-wide uppercase border border-white/20 mb-4">
            Spiritual Tools
          </span>
          ...
          <p className="text-emerald-200 text-lg max-w-2xl mx-auto">
            Built-in Islamic tools that help you stay connected to your faith every single day.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {tools.map((tool, i) => (
            <motion.div
              ...
              className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-7 overflow-hidden cursor-default transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:shadow-2xl"
            >
              {/* Glow on hover */}
