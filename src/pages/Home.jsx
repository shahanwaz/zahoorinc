    ...
    <div className="space-y-6 relative bg-gradient-to-br from-emerald-50 via-emerald-25 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <div className="px-4 space-y-8">
          ...
          {/* Live Streams Section - Only shows when streams are active */}
          <LiveStreamsSection />

          {/* Ejara Section - Light Emerald Theme */}
          <EjaraSection />

          {/* Upcoming Majalis & Events - Redesigned */}
          ...
          {/* Support Our Community - Fixed Button Layout */}
